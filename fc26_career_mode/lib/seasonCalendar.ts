...
// Сжато под реальную длину сезона лиги: 38 туров с еженедельным шагом от
// 16 августа заканчиваются к началу мая — раньше даты плей-офф уходили аж
// до 30 мая (реальный календарь УЕФА), то есть ПОСЛЕ конца лигового
// календаря. Раз промотка сезона и блокировка по датам завязаны на туры
// лиги, а не на настоящий календарь, финал турнира физически никогда не
// наступал бы. Теперь весь плей-офф укладывается в январь-апрель.
const CL_KNOCKOUT_DATES: Record<KnockoutStage, string[]> = {
  playoff: ["2026-02-04", "2026-02-11"], r16: ["2026-02-25", "2026-03-04"],
  qf: ["2026-03-18", "2026-03-25"], sf: ["2026-04-08", "2026-04-15"], final: ["2026-04-29"],
};
const EL_KNOCKOUT_DATES: Record<KnockoutStage, string[]> = {
  playoff: ["2026-02-05", "2026-02-12"], r16: ["2026-02-26", "2026-03-05"],
  qf: ["2026-03-19", "2026-03-26"], sf: ["2026-04-09", "2026-04-16"], final: ["2026-04-23"],
};
const ECL_KNOCKOUT_DATES: Record<KnockoutStage, string[]> = {
  playoff: ["2026-02-06", "2026-02-13"], qf: ["2026-02-27", "2026-03-06"],
  sf: ["2026-03-20", "2026-03-27"], final: ["2026-04-10"], r16: ["2026-02-20", "2026-02-27"],
};
